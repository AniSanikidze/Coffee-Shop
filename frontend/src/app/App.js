...
function App() {
  ...
  let [clickedUserMenuItem, setClickedUserMenuItem] = useState("customerinfo");
          ...
          <Switch>
            <UserContext.Provider
              value={{
                ...
                setPrice,
                singleOriginFilter,
                setSingleOriginFilter,
                origin,
                setOrigin,
                clickedUserMenuItem,
                setClickedUserMenuItem,
                generalSearchPath,
                setGeneralSearchPath,
                incorrectPassword,
                setIncorrectPassword,
                stripeApiKey,
                setStripeApiKey,
                deleteProductSubmitted,
                setDeleteProductSubmitted,
                deleteOrderSubmitted,
                setDeleteOrderSubmitted,
                deleteUserSubmitted,
                setDeleteUserSubmitted,
              }}
            >
              <Switch>
