          ...
          <div className="filter-inner-div">
            ...
            <div className="filter-options">
              <li
                ...
                style={{
                  textDecoration: singleOriginFilter === true && "underline",
                }}
                onClick={() => {
                  setOrigin(null);
              ...
              <li
                className="category-link"
                style={{
                  textDecoration: singleOriginFilter === false && "underline",
                }}
                onClick={() => {
                  setOrigin(null);
            ...
            <div className="filter-options">
              {origins.map((originItem) => (
                <li
                  ...
                  style={{
                    textDecoration: origin === originItem && "underline",
                  }}
                >
                  {originItem}
                </li>
