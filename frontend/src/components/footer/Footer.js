    ...
    <div className="footer-container">
      ...
      <div className="footer-center">
        ...
        <ul className="footer-link-list">
          <li className="footer-link"><Link to='/' style={{textDecoration: 'none',color: "#000"}}>Home</Link></li>
          ...
          <li className="footer-link">         
            ...
            About us</Link></li>
            <li className="footer-link"><Link to='/coffee' style={{textDecoration: 'none',color: "#000"}}>Coffee Shop</Link></li>
            <li className="footer-link"><Link to='/' style={{textDecoration: 'none',color: "#000"}}>Privacy Policy</Link></li>
        </ul>
      </div>
      <div className="footer-right-content-wrapper">
        <h3 className="footer-title">Contact</h3>
        <div className="footer-contact-item">
          <Room style={{marginRight:"10px"}}/> 12 Digmis Masivi, Tbilisi, Georgia
        </div>
        <div className="footer-contact-item">
          <Phone style={{marginRight:"10px"}}/> +995 599 08 08 31
        </div>
        <div className="footer-contact-item">
          <MailOutline style={{marginRight:"10px"}} /> infocoffeeberry@yahoo.com
        </div>
      </div>
    </div>
  );
