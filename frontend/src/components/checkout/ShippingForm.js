...
function ShippingForm() {
  ...
  const cities = City.getCitiesOfCountry("GE").filter((item) => {
    return (
      ...
      !item.name.includes("Gagra") &&
      !item.name.includes("Gali") &&
      !item.name.includes("Sokhumi") &&
    ...
    <div className="shipping-form" style={{ padding: "3rem" }}>
      <form onSubmit={handleSubmit} className="form">
        ...
        <div className="change-password">
          <div
            className="shipping-address-header"
            style={{
              width: "100%",
              textAlign: "center",
          ...
          <div className="form-inputs">
            <label className="input-field">Street address</label>
            <input
          ...
          <div className="form-inputs">
            <label className="input-field">Town / City</label>
            <select
            ...
            <span className="shipping-info-note">
              Shipping Information: Shipping fee in Tbilisi - 5₾, other cities -
              10₾.
            </span>
          </div>
          <div className="form-inputs">
            <label className="input-field">Zip code</label>
            <input
              className={"form-input"}
              name="zip"
          ...
          <div className="fomr-inputs">
            <label className="input-field">Phone number</label>
            <input
              className={"form-input"}
              name="phone"
